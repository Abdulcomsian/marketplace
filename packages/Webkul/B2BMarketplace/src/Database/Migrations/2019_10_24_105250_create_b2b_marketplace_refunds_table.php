...
class CreateB2BMarketplaceRefundsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('b2b_marketplace_refunds', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('b2b_marketplace_order_id')->unsigned()->nullable();
