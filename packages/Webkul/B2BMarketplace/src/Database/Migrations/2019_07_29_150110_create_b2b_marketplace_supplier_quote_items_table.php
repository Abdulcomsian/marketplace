...
class CreateB2bMarketplaceSupplierQuoteItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('b2b_marketplace_supplier_quote_items', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('b2b_marketplace_supplier_quote_items');
    }
}
