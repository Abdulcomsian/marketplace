 ...
 */
class AnsweredDataGrid extends DataGrid
{
    /**
     * @var integer
     */
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder =  DB::table('b2b_marketplace_customer_quotes')
            ...
            ->Select(
                ...
                'b2b_marketplace_customer_quote_items.quantity',
                'b2b_marketplace_customer_quote_items.created_at',
                DB::raw('CONCAT(customers.first_name, " ", customers.last_name) as customer_name')
            )
            ->where('b2b_marketplace_customer_quote_items.status', '=', 'Answered')
