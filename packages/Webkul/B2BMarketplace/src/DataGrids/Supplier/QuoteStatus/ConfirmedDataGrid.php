...
/**
 * Confirmed status Data Grid class
 *
 * @copyright 2019 Webkul Software Pvt Ltd (http://www.webkul.com)
 */
class ConfirmedDataGrid extends DataGrid
{
    /**
     * @var integer
     */
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder =  DB::table('b2b_marketplace_customer_quotes')
            ...
            ->Select(
                ...
                'b2b_marketplace_customer_quote_items.status', 'b2b_marketplace_customer_quote_items.quote_id',
                'product_flat.name as product_name','b2b_marketplace_customer_quote_items.product_id','b2b_marketplace_customer_quote_items.quantity','b2b_marketplace_customer_quote_items.created_at',
                DB::raw('CONCAT(customers.first_name, " ", customers.last_name) as customer_name'), 'b2b_marketplace_customer_quote_items.quote_status'
            )
            ->where('b2b_marketplace_customer_quote_items.status', '=', 'Approved')
    ...
    public function addColumns()
    {
        ...
        $this->addColumn([
            ...
            'wrapper' => function($row) {
                ...
                [ $row->id, $row->product_id ]) . '">' . trans('b2b_marketplace::app.shop.rfq.response') . '</a>';
            }
        ]);
    }
}
