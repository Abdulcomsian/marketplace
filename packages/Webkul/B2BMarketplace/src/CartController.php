        ...
        if ($cart) {
            ...
            foreach ($items as $index => $item) {
                ...
                if(isset($item['additional']['supplier_info'])){
                    $cartItems[$index]['supplier_product'] = true; 
                    ...
                    $cartItems[$index]['supplier_info'] = ['supplier'=> $supplier, 'rating' => app('Webkul\B2BMarketplace\Repositories\ReviewRepository')->getAverageRating($supplier)];
                }
