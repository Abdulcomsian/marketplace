...
<div class="auth-content">
    ...
    {!! view_render_event('b2bmarketplace.shop.suppliers.reset_password.before') !!}

    <form method="post" action="{{ route('supplier.reset-password.store') }}" @submit.prevent="onSubmit">
