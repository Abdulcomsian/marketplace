        ...
        <div class="account-layout">
            ...
            <form method="POST" action="{{ route('b2b_marketplace.home.products.rfq.store', $product->product_id) }}"
                ...
                <div class="account-head mb-10">
                    ...
                    <button type="submit" class="btn btn-lg btn-primary" name="button" id="wk-rfq-submit-btn">
                        <span>
                            {{ __('b2b_marketplace::app.shop.supplier.account.rfq.rfq-title') }}
                        </span>
                    </button>
                ...
                <div class="account-item-list">
                    <div class="account-table-content">
                                                        ...
                                                        <div class="supplier-products-row-container"
                                                            ...
                                                            <div class="supplier-header-txt fieldset">
                                                                <div class="control-group"
                                                                    :class="[errors.has('quote-title') ? 'has-error' : '']">
                                                                    ...
                                                                    <input type="text" v-validate="'required'"
                                                                        class="control product-search-box" id="quote-title"
                                                                        name="quote-title" value="{{ old('quote-title') }}"
                                                                        data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-title') }}&quot;" />
                                                                    <span class="control-error"
                                                                        v-if="errors.has('quote-title')">@{{ errors.first('quote-title') }}</span>
                                                                </div>

                                                                <div class="control-group"
                                                                    :class="[errors.has('quote-brief') ? 'has-error' : '']">
                                                                    <label for="label-text required" class="required">
                                                                        {{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-description') }}
                                                                    </label>
                                                                    <textarea type="text" class="control" id="quote-brief" name="quote-brief" v-validate="'required'"
                                                                        value="{{ old('quote-brief') }}"
                                                                        data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-description') }}&quot;"></textarea>
                                                                    <span class="control-error"
                                                                        v-if="errors.has('quote-brief')">@{{ errors.first('quote-brief') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="supplier-products-row-container"
                                                            ...
                                                            <div class="supplier-header-txt fieldset">
                                                                ...
                                                                <div class="control-group"
                                                                    ...
                                                                    <input type="text" v-validate="'required'"
                                                                        class="control product-search-box"
                        ...
                        <accordian
                            :title="'{{ __('b2b_marketplace::app.shop.supplier.account.rfq.product-information') }}'"
                            :active="true">
                            <div slot="header">
                                ...
                                <div class="form-container">
                                    <div class="rfq-product-section">
                                        ...
                                        <div class="supplier-header-txt fieldset">
                                            ...
                                            <input type="hidden" name="products[product_name]"
                                                value="{{ $product->name }}">

                                            <input type="hidden" name="products[product_id]"
                                                value="{{ $product->product_id }}">

                                            <input type="hidden" name="products[category_id]"
                                                value="{{ $categories }}">
                                            ...
                                            <div class="control-group"
                                                ...
                                                <textarea type="text" class="control" id="description" name="products[description]" v-validate="'required'"
                                                    value="{{ old('products[description]') }}"
                                            ...
                                            <div class="control-group"
                                                ...
                                                <input type="text" class="control product-search-box" id="quantity"
                                                    name="products[quantity]" v-validate="'required|numeric'"
                                                    value="{{ old('products[quantity]') }}"
                                            ...
                                            <div class="control-group"
                                                ...
                                                <input type="text" class="control product-search-box" id="priceperqty"
                                                    ...
                                                    value="{{ old('products[priceperqty]') }}"
