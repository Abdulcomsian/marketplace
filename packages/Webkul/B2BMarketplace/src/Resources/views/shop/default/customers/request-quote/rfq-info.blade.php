                        ...
                        <div class="supplier-request-quote">
                            ...
                            <div class="supplier-products-row-container" style="background:white !important; padding: 0px !important">
                                ...
                                <div class="supplier-header-txt fieldset">
                                    ...
                                    <div class="control-group" :class="[errors.has('rfq-form.quote_title') ? 'has-error' : '']">
                                        <label class="label-text required">
                                            {{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-title') }}
                                        </label>

                                        <input type="text" v-validate="'required'" style="width:100%;" class="control product-search-box" id="quote_title" name="quote_title" v-model="rfq_info.quote_title" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-title') }}&quot;"/>
                                        <span class="control-error" v-if="errors.has('rfq-form.quote_title')">@{{ errors.first('rfq-form.quote_title') }}</span>
                                    </div>

                                    <div class="control-group" :class="[errors.has('rfq-form.quote_brief') ? 'has-error' : '']">
                                        <label for="label-text required" class="required">
                                            {{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-description') }}
                                        </label>
                                        <textarea type="text" style="width:100%;" class="control" id="quote_brief" name="quote_brief" v-validate="'required'" v-model="rfq_info.quote_brief" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-description') }}&quot;"></textarea>
                            ...
                            <div class="supplier-products-row-container" style="background:white !important; padding: 0px !important">
                                <h3>{{ __('b2b_marketplace::app.shop.supplier.account.rfq.contact-info') }}</h3>
                                ...
                                <div class="supplier-header-txt fieldset">
                                    ...
                                    <div class="control-group" :class="[errors.has('rfq-form.name') ? 'has-error' : '']">
                                        ...
                                        <input type="text" v-validate="'required'" style="width:100%;" class="control product-search-box" id="name" name="name" v-model="rfq_info.name" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.name') }}&quot;"/>
                                    ...
                                    <div class="control-group" :class="[errors.has('rfq-form.company_name') ? 'has-error' : '']">
                                        ...
                                        <input type="text" v-validate="'required'" style="width:100%;" class="control product-search-box" id="company_name" name="company_name" v-model="rfq_info.company_name" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.company-name') }}&quot;"/>
                                    ...
                                    <div class="control-group" :class="[errors.has('rfq-form.address') ? 'has-error' : '']">
                                        ...
                                        <input type="text" v-validate="'required'" style="width:100%;" class="control product-search-box" id="address" name="address" v-model="rfq_info.address" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.address') }}&quot;"/>
                                    ...
                                    <div class="control-group" :class="[errors.has('rfq-form.contact_number') ? 'has-error' : '']">
                                        ...
                                        <input type="text" v-validate="'required|numeric'" style="width:100%;" class="control product-search-box" id="contact_number" name="contact_number" v-model="rfq_info.contact_number" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.contact-number') }}&quot;"/>
