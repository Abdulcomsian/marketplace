        ...
        <div class="container">
            <div class="col-lg-10 col-md-12 offset-lg-1">
                ...
                <div class="body col-12">
                    ...
                    {!! view_render_event('b2bmarketplace.shop.suppliers.forget_password.before') !!}

                    <form
                        method="post"
                        action="{{ route('supplier.forgot-password.store') }}"
                        ...
                        <div class="control-group" :class="[errors.has('email') ? 'has-error' : '']">
                            <label for="email" class="mandatory label-style">{{ __('shop::app.customer.forgot-password.email') }}</label>
                    ...
                    {!! view_render_event('b2bmarketplace.shop.suppliers.forget_password.after') !!}
                </div>
            </div>
        </div>
    </div>
