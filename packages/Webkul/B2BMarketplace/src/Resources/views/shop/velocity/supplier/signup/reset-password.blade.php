            ...
            <div class="container">
                <div class="col-lg-10 col-md-12 offset-lg-1">
                    ...
                    <div class="body col-12">
                        ...
                        {!! view_render_event('bagisto.shop.supplier.forget_password.before') !!}

                        <form
                            method="POST"
                            @submit.prevent="onSubmit"
                            action="{{ route('supplier.reset-password.store') }}">

                            {{ csrf_field() }}

                            <input type="hidden" name="token" value="{{ $token }}">

                            {!! view_render_event('bagisto.shop.supplier.forget_password_form_controls.before') !!}
                            ...
                            {!! view_render_event('bagisto.shop.supplier.forget_password_form_controls.after') !!}
                        ...
                        {!! view_render_event('bagisto.shop.supplier.forget_password.after') !!}
                    </div>
                </div>
            </div>
        </div>
