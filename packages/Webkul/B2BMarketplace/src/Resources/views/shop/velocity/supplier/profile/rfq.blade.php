                        ...
                        <div class="supplier-request-quote">
                                ...
                                <div class="supplier-products-row-container" style="background:white !important; padding: 0px !important">
                                    ...
                                    <div class="supplier-header-txt fieldset">
                                        <div class="form-group" :class="[errors.has('quote_title') ? 'has-error' : '']">
                                            <label class="label-text mandatory">
                                                {{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-title') }}
                                            </label>

                                            <input type="text" v-validate="'required'" class="form-style product-search-box" id="quote_title" name="quote_title" value="{{ old('quote-title') }}" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-title') }}&quot;"/>
                                            <span class="control-error" v-if="errors.has('quote_title')">@{{ errors.first('quote_title') }}</span>
                                        </div>

                                        <div class="form-group" :class="[errors.has('quote_brief') ? 'has-error' : '']">
                                            <label for="label-text mandatory" class="required">
                                                {{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-description') }}
                                            </label>
                                            <textarea type="text" class="form-style" id="quote_brief" name="quote_brief" v-validate="'required'" value="{{ old('quote_brief') }}" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.quote-description') }}&quot;"></textarea>
                                ...
                                <div class="supplier-products-row-container" style="background:white !important; padding: 0px !important">
                                    ...
                                    <div class="supplier-header-txt fieldset">
                                        <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                                            ...
                                            <input type="text" v-validate="'required'" class="form-style product-search-box" id="name" name="name" value="{{ old('name') }}" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.name') }}&quot;"/>
                                        ...
                                        <div class="form-group" :class="[errors.has('company_name') ? 'has-error' : '']">
                                            ...
                                            <input type="text" v-validate="'required'" class="form-style product-search-box" id="company_name" name="company_name" value="{{ old('company_name') }}" data-vv-as="&quot;Company Name&quot;"/>
                                        ...
                                        <div class="form-group" :class="[errors.has('address') ? 'has-error' : '']">
                                            ...
                                            <input type="text" v-validate="'required'" class="form-style product-search-box" id="address" name="address" value="{{ old('address') }}" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.address') }}&quot;"/>
                                            <span class="control-error" v-if="errors.has('address')">@{{ errors.first('address') }}</span>
                                        </div>

                                        <div class="form-group" :class="[errors.has('contact_number') ? 'has-error' : '']">
                                            <label class="label-text mandatory">
                                                {{ __('b2b_marketplace::app.shop.supplier.account.rfq.contact-number') }}
                                            </label>

                                            <input type="text" v-validate="'required'" class="form-style product-search-box" id="contact_number" name="contact_number" value="{{ old('contact_number') }}" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.contact-number') }}&quot;"/>
                                ...
                                <div class="wk-supplier-btn-wrapper">
                                    ...
                                    <div class="form-group" :class="[errors.has('files') ? 'has-error' : '']">
                                        <label class="label-text">
                                            {{ __('b2b_marketplace::app.shop.supplier.account.rfq.add-attachment') }}
                                        </label>

                                        <input type="file" name="files" v-validate class="form-style file-field" id="rfq-file-field" data-vv-as="File" data-url="" data-vv-rules="">
                ...
                <div class="control-group">
                    <table class="rfq-product-table">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('b2b_marketplace::app.shop.supplier.account.rfq.quantity') }}</th>
                    ...
                    <div class="supplier-products-row-container" style="padding: 15px;
                        ...
                        <div class="supplier-header-txt fieldset">
                            ...
                            <div class="form-group" :class="[errors.has('product-form.billing.name') ? 'has-error' : '']">
                                <label class="label-text mandatory">
                                ...
                                <label class="label-text" style="color:#21a179" v-show="billing.product_id && billing.product_id != null">
                                    Product Price: @{{formatedPrice}}
                                </label>

                                <div class="dropdown-list bottom-left product-search-list" style="top:auto; bottom:auto;">
                                        ...
                                        <ul style="list-style-type: none;">
                                            <li v-if="products.length" class="table dropdown-toggle">
                                                <table id="productTable" class="productTable">
                                                    <tbody>
                                                        <tr v-for='(product, index) in products' v-on:click = "getProductId(product)" :id="product.id" :name="product.name" :price="product.formated_price">
                                                            <td>
                            ...
                            <div class="form-group" :class="[errors.has('product-form.billing.description') ? 'has-error' : '']">
                                <label for="label-text mandatory" class="required">
                                    {{ __('b2b_marketplace::app.shop.supplier.account.rfq.product-description') }}
                                </label>
                                <textarea type="text" class="form-style" id="billing.description" name="billing.description" v-model="billing.description" v-validate="'required'" value="{{ old('description') }}" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.product-description') }}&quot;" data-vv-scope="product-form"></textarea>
                            ...
                            <div class="form-group" :class="[errors.has('product-form.billing.quantity') ? 'has-error' : '']">
                                <label class="label-text mandatory">
                                    {{ __('b2b_marketplace::app.shop.supplier.account.rfq.product-qty') }}
                                </label>

                                <input type="text" class="form-style product-search-box" id="billing.quantity" name="billing.quantity" v-model="billing.quantity" v-validate="'required|numeric'" value="{{ old('quantity') }}" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.product-qty') }}&quot;" data-vv-scope="product-form"/>
                                <span class="control-error" v-if="errors.has('product-form.billing.quantity')">@{{ errors.first('product-form.billing.quantity') }}</span>
                            </div>

                            <div class="form-group" :class="[errors.has('product-form.billing.priceperqty') ? 'has-error' : '']">
                                <label class="label-text mandatory">
                                    {{ __('b2b_marketplace::app.shop.supplier.account.rfq.price-per-qty') }}
                                </label>

                                <input type="text" class="form-style product-search-box" id="billing.priceperqty" name="billing.priceperqty" v-model="billing.priceperqty" v-validate="'required|decimal'" value="{{ old('priceperqty') }}" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.price-per-qty') }}&quot;" data-vv-scope="product-form">
                        ...
                        <div class="supplier-header-txt fieldset">
                            <div class="form-group" :class="[errors.has('product-form.billing.is_sample') ? 'has-error' : '']">
                                <label for="is_sample" class="mandatory">
                                    {{ __('b2b_marketplace::app.shop.supplier.account.rfq.is-samples') }}
                                </label>
                                <select class="form-style" v-validate="'required'" id="is_sample" name="billing.is_sample" v-model="billing.is_sample" data-vv-as="&quot;{{ __('b2b_marketplace::app.shop.supplier.account.rfq.is-samples') }}&quot;" data-vv-scope="product-form">
                            ...
                            <div class="add-btn" style="margin-bottom: 5px;">
                                <button v-if="billing.product_id && billing.product_id != null" type="button" id="rfq-add-product" class="theme-btn" @click= "validateForm('product-form')">
                                    {{ __('b2b_marketplace::app.shop.supplier.account.rfq.add-product') }}
                                </button>

                                <button v-else="billing.product_id && billing.product_id != null" disabled type="button" id="rfq-add-product" class="theme-btn" @click= "validateForm('product-form')">
                                    {{ __('b2b_marketplace::app.shop.supplier.account.rfq.add-product') }}
                                </button>
                            </div>
                        ...
                        <div class="supplier-header-txt fieldset">
                            <div class="add-btn">
                                <button type="submit" class="theme-btn" name="button1" id="btn" :disabled="disable_button">
                                    <span>
                                        {{ __('b2b_marketplace::app.shop.supplier.account.rfq.rfq-title') }}
                                    </span>
                                </button>
        ...
        Vue.component('product-search', {
            ...
            methods: {
                ...
                getProductId: function (product) {
                    ...
                    this_this.billing['product_id'] = product.id;
                    this_this.billing['product_name'] = product.name;
                ...
                saveProduct: function() {
                    ...
                    this.$http.post ("{{ route('b2b_marketplace.shop.customers.rfq.addproduct') }}",this.billing)
                        ...
                        window.showAlert(`alert-success`, this.__('shop.general.alert.success'), 'Product Added Successfully.');
                    })
                ...
                deleteProduct: function(productId) {
                    ...
                    window.showAlert(`alert-success`, this.__('shop.general.alert.success'), 'Product Removed Successfully.');
                }
            }
        });
    </script>
