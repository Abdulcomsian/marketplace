        ...
        @auth('customer')
            <ul type="none" class="vc-customer-options">
                ...
                @if (core()->getConfigData('b2b_marketplace.settings.general.status'))
                    ...
                    <li>
                        <a href="{{ route('b2b_marketplace.customers.account.supplier.messages.index') }}" class="unset">
                            <i class="icon message text-down-3"></i>
                            <span>Supplier's Message</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('b2b_marketplace.shop.customers.rfq.show') }}" class="unset">
                            <i class="icon quote-request text-down-3"></i>
                            <span>My Requested Quotes</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('b2b_marketplace.shop.customers.rfq.index') }}" class="unset">
                            <i>
                            <img class="logo" src="{{ asset('themes/b2b/assets/images/velocity-Icon-RFQ.svg') }}" alt="" style="width: 30px !important;
                            margin-left: -13px !important;" height="20" width="20"/> </i>
                            <span>
        ...
        @if (core()->getConfigData('b2b_marketplace.settings.general.status'))
            <li>
                @guest('customer')
                    <a
                        class="unset"
                        href="{{ route('b2b_marketplace.shop.supplier.session.index') }}">
                        <span>{{__('Supplier')}} {{ __('shop::app.header.sign-in') }}</span>
                    </a>
                @endguest
            </li>
            ...
            <li>
                @guest('customer')
                    <a
                        class="unset"
                        href="{{ route('b2b_marketplace.shop.suppliers.signup.index') }}">
                        <span>{{__('Supplier')}} {{ __('shop::app.header.sign-up') }}</span>
                    </a>
                @endguest
            </li>
            ...
            <li>
                @guest('customer')
                    <a
                        class="unset"
                        href="{{ route('b2b_marketplace.supplier_central.index') }}">
                        <span>{{ __('b2b_marketplace::app.shop.supplier.layouts.sell') }}</span>
                    </a>
                @endguest
            </li>
        @endif
