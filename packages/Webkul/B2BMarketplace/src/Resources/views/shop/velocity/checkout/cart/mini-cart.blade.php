                ...
                <div
                    ...
                    <div class="col-3 product-image-container mr15">
                        ...
                        <a
                            ...
                            <div
                                ...
                                "
                                v-if = "item.additional.supplier_info"
                            ></div>
                    ...
                    <div class="col-9 no-padding card-body align-vertical-top">
                        <div class="no-padding">
                            ...
                            <div class="supplier-info" :id ="`mini-cart-supplier-info-${item.id}`" style="margin-bottom: 10px;">
                                <div v-if="item.supplier_product">
                                    <div v-if="supplierInfo[item.product_id]['supplier'] != 0" >
                                        Sold By : <a href="">@{{item.supplier_info.supplier.company_name}}[<i class="material-icons" style="width: 12px; font-size: 10px;">star_rate</i>@{{item.supplier_info.rating}}]</a>
                                    </div>
                                </div>
                             </div>
        ...
        template: '#mp-mini-cart-template',
         ...
         methods: {
             ...
             getSupplierInfo: function () {
                 ...
                 this.$http.post(`${this.$root.baseUrl}/supplier/supplier-info`, this.cartItems)
                 .then(response => {
