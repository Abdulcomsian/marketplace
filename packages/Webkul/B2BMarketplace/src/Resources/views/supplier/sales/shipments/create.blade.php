...
@section('content-wrapper')
    <div class="content full-page">
        <form method="POST" action="{{ route('b2b_marketplace.supplier.sales.shipments.store', $order->id) }}" @submit.prevent="onSubmit">
            @csrf()
                            ...
                            <div class="sale-section">
                                ...
                                <div class="section-content">
                                    <div class="row">
                                        ...
                                        <span class="value">
                                            <a href="{{ route('b2b_marketplace.supplier.sales.orders.view', $order->id) }}">#{{ $order->increment_id }}</a>
                                        </span>
                                    </div>
    ...
    <script type="text/x-template" id="order-item-list-template">
        ...
        <div class="table">
            ...
            <table>
                ...
                <tbody>
                    @foreach ($supplierOrder->items as $supplierItem)
                    <?php $item = $supplierItem->item;  ?>
