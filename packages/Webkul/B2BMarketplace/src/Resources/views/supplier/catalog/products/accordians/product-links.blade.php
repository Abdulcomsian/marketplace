{!! view_render_event('b2b_marketplace.supplier.catalog.product.edit_form_accordian.product_links.before', ['product' => $product]) !!}
...
{!! view_render_event('b2b_marketplace.supplier.catalog.product.edit_form_accordian.product_links.after', ['product' => $product]) !!}
        ...
        methods: {
            ...
            search: function (key) {
                ...
                if (this.search_term[key].length >= 1) {
                    this.$http.get ("{{ route('b2b_marketplace.catalog.products.productlinksearch') }}", {params: {query: this.search_term[key]}})
