            ...
            <div class="nav-top">
                <div class="pro-info">
                    <div class="profile-info-icon">
                        <span style="">{{ substr(auth()->guard('supplier')->user()->name, 0, 1) }}</span>
                    </div>
            ...
            <div class="nav-items">
                @foreach ($menu->items as $menuItem)
                    <div class="nav-item {{ $menu->getActive($menuItem) }}">
                        <a class="nav-tab-name" href="{{ (($menuItem['key'] == 'dashboard') || ($menuItem['key'] == 'messages')) ? $menuItem['url'] : '#' }}">
                ...
                <div class="nav-item">
                    ...
                    <ul>
                        ...
                        <li  class="navbar-child">
                            <a href="{{ route('b2b_marketplace.supplier.settings.index') }}">
                                <span style="margin-left:47px">{{ __('admin::app.layouts.my-account') }}</span>
                            </a>
                        </li>
                        <li  class="navbar-child">
                            <a href="{{ route('b2b_marketplace.session.destroy') }}">
