...
<html lang="{{ config('app.locale') }}">
    ...
    <body @if (app()->getLocale() == 'ar') class="rtl" @endif style="scroll-behavior: smooth;">
        <div id="app" class="container">
            ...
            <div class="center-box">
                ...
                <div class="adjacent-center">
                    ...
                    {!! view_render_event('b2b_marketplace.supplier.layout.content.before') !!}

                    @yield('content')

                    {!! view_render_event('b2b_marketplace.supplier.layout.content.after') !!}
        ...
        {!! view_render_event('b2b_marketplace.supplier.layout.body.after') !!}
