...
@section('page_title')
    {{ __('b2b_marketplace::app.admin.suppliers.supplier-roles.add-role-title') }}
@stop

@section('content')
    <div class="content">

        <form method="POST" action="{{ route('b2b_marketplace.admin.roles.store') }}" @submit.prevent="onSubmit">
