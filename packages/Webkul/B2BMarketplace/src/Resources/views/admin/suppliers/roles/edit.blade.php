...
@section('page_title')
    {{ __('b2b_marketplace::app.admin.suppliers.supplier-roles.edit-role-title') }}
@stop

@section('content')
    <div class="content">

        <form method="POST" action="{{ route('b2b_marketplace.admin.supplier.roles.update', $role->id) }}" @submit.prevent="onSubmit">
