...
@section('page_title')
    {{ __('b2b_marketplace::app.admin.supplier.assign-product') }}
@stop
            ...
            <div class="account-table-content">
                ...
                <div class="product-information" style="display: inline-flex;">
                    ...
                    <div class="product-image">
                        <img src="{{ $baseProduct->base_image_url ?: bagisto_asset('themes/b2b/assets/images/product/meduim-product-placeholder.png') }}"
                    ...
                    <div class="product-details" style="padding-left: 20px;">
                        ...
                        <span style="font-size: 20px;">
                            @include ('b2b_marketplace::admin.products.price', ['product' => $baseProduct])
                        </span>
                    </div>
        ...
        <tr>
            ...
            <td>
                <div class="control-group" :class="[errors.has(variantInputName + '[price]') ? 'has-error' : '']">
                    <input type="text" v-validate="'required'" :name="[variantInputName + '[price]']" class="control" data-vv-as="&quot;{{ __('admin::app.products.price') }}&quot;" value="0" :disabled="!selected_variants[variant.id]"/>
