    ...
    @else
        @if ($product->getTypeInstance()->haveSpecialPrice())
            ...
            <span class="regular-price"
                style="text-decoration: line-through;">{{ core()->currency($product->price) }}</span>

            <span
                class="special-price">{{ core()->currency($product->getTypeInstance()->getSpecialPrice($product)) }}</span>
        @else
