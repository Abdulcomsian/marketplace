...
return [
    [
        ...
        'route' => 'b2b_marketplace.supplier.catalog.products.create',
        'sort' => 3,
        'icon-class' => 'product-icon',
    ], [
        'key' => 'products.search',
        'name' => 'b2b_marketplace::app.shop.supplier.layouts.search',
        ...
        'key' => 'products.show.edit',
        'name' => 'Edit',
        'route' => 'b2b_marketplace.supplier.catalog.products.edit',
        'sort' => 1,
    ], [
        'key' => 'products.show.delete',
        'name' => 'Delete',
        'route' => 'b2b_marketplace.supplier.catalog.products.delete',
        'sort' => 2,
    ], [
        'key' => 'products.show.update',
        'name' => 'Update',
        'route' => 'b2b_marketplace.supplier.catalog.products.update',
        'sort' => 3,
    ], [
        'key' => 'sales',
