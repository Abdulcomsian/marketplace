...
namespace Webkul\B2BMarketplace\Helpers;
...
use Webkul\B2BMarketplace\Repositories\ProductRepository as B2BProduct;
...
class Helper extends Review
{
    ...
    /**
     * B2BProduct Repository instance
     *
     * @var B2BProduct
     */
    ...
    public function totalQuantity($product)
    {
        ...
        if(isset($product->product_id)) {
            ...
            $supplier = $this->b2BProduct->getSupplierByProductId($product->product_id);
        } else {
            $supplier = $this->b2BProduct->getSupplierByProductId($product->id);
        }
