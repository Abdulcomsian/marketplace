 ...
 */
class NewSupplierMessageNotification extends Mailable
{
    ...
    public function build()
    {
        return $this->from(core()->getSenderEmailDetails()['email'], core()->getSenderEmailDetails()['name'])
            ->to($this->thread->customer->email, $this->thread->customer->first_name . ' ' . $this->thread->customer->last_name)
            ->subject(trans('b2b_marketplace::app.mail.message.subject'))
            ->view('b2b_marketplace::emails.message.supplier-msg',[
